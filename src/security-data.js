...
export const audytyData = {
  ...
  3: {
    ...
    audience: 'Firmy wymagające pełnego cyklu: diagnoza → wdrożenie → walidacja. Dla tych, którzy chcą udowodnić bezpieczeństwo, nie tylko je zadeklarować.',
    benefits: [
      'Wszystko z pakietu ROZSZERZONY',
      '3 miesiące vCISO — 4h/miesiąc konsultacji senior security',
    ...
    outcome: 'Pełna zgodność NIS2 + 3 miesiące opieki vCISO + dokumentacja pod ubezpieczenie + zespół przeszkolony. Cena od 25 000 PLN netto.',
  },
  4: {
    title: 'Virtual CISO',
    category: '_04 // vCISO',
    ...
    benefits: [
      '8h miesięcznie elastycznej pracy senior security (priorytety i zadania ustalamy razem)',
      'Miesięczny Executive Report dla zarządu — ryzyka, statusy, rekomendacje',
    ...
    outcome: 'Wewnętrzne "mam CISO" bez kosztu etatu. Cena od 4 500 PLN/mies netto (firmy do 50 os). Większe organizacje — wycena indywidualna.',
  },
};
